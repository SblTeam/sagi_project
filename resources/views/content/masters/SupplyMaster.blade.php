    ...
    <table class="table w-100" id="datatable_set">
      ...
      <tbody class="table-border-bottom-0">
        ...
        <tr>
          ...
          <td>@if($details->auth_flag2!=1) <i class="bx bx-trash me-1" style="color: red" onclick="if(confirm('Are you sure you want to delete?')) { window.location.href='{{ route('masters-SupplyMaster.destroy', $details->id) }}'; }"></i>
            ...
            <i class="bx bx-lock-alt me-1" style="color:black "></i>
             @endif
             <i class="bx bx-edit-alt me-1" style="color: #03c3ec" onclick="window.location.href='{{ route('masters-SupplyMaster.edit', $details->id)}}'"></i>
            </td>
          </tr>
        @endforeach
