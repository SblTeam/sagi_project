...
<script>
  ...
  function addNewRow(rowNumber,category, description, code, quantity, price, taxable, basic, tax, tax_value, tax_amount, Total) {
    ...
    newRow.innerHTML = `
        ...
        <td>
            <input type="number" id="quantity${rowNumber}" name="quantity[]" class="form-control" value="${quantity}" required readonly/>
        </td>
        ...
        <td>
            ...
            readonly/>
             ...
             <td>
                <input type="number" id="taxable${rowNumber}" name="taxable[]" readonly class="form-control" value="${taxable}" required/>
            </td>
               <td>
                <input type="number" id="basic${rowNumber}" name="basic[]" readonly class="form-control" value="${basic}" required/>
            </td>
        <td>
            <select id="tax${rowNumber}" name="tax[]" class="form-control" required>
                <option value="${tax}">${tax}</option>
            </select>
        </td>
        <td>
            <input type="number" id="tax_value${rowNumber}" name="tax_value[]" class="form-control" value="${tax_value}" readonly/>
        </td>
         <td>
            <input type="number" id="taxamount${rowNumber}" name="taxamount[]" class="form-control" value="${tax_amount}" readonly/>
        </td>
         <td>
            <input type="number" id="Total${rowNumber}" name="Total[]" class="form-control" value="${Total}" readonly/>
        </td>
    `;
                        ...
                        <table class="table">
                            ...
                            <tbody id="dynamic-rows">
                                <tr class="dynamic-row mb-1" id="dynamic-row-1">
                                    ...
                                    <td>
                                        <input type="number" id="quantity1" name="quantity[]" class="form-control" required readonly/>
                                    </td>
                                    <td>
                                        <input type="number" id="price1" name="price[]" class="form-control" required readonly/>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <input type="number" id="taxableprice1" name="taxableprice[]" readonly class="form-control" />
                                    </td>
                                    <td>
                                        <input type="number" id="basic_total" name="basic_total[]" readonly class="form-control" />
                                    </td>
                                    <td>
                                        <input type="number" id="tax1" name="tax[]" class="form-control" readonly/>
                                    </td>
                                    <td>
                                        <input type="number" id="taxamount" name="taxamount[]" class="form-control" readonly/>
                                    </td>
                                    <td>
